...
public class SendAmountManager {

    private static final String TAG = SendAmountManager.class.getSimpleName();

    public void SendAmountManager(Context context, String params) {
        ...
        protected void onPostExecute(String s) {
            ...
            if (s != null) {
                try {
                    ...
                    EventBus.getDefault().post(new Event(Constant.SENDCASH, ""));

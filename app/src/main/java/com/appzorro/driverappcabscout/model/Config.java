...
public class Config {
    ...
    public static final String card_image_url = "http://traala.com/cabscout/identity/";
    ...
    public static final String pathurl_image = "http://traala.com/cabscout/path_image/";
    public static final String customerrequesturl = "http://traala.com/cabscout/driver_api.php?action=get_customer_list&driver_id=";
    public static final String customer_status = "http://traala.com/cabscout/driver_api.php?action=customer_detail&customer_id=";
    ...
    public static final String getdailyearning = "http://traala.com/cabscout/driver_api.php?action=daily_earning&driver_id=";
    public static final String rejectrequestbydriver = "http://traala.com/cabscout/driver_api.php?action=requestRejectedByDriver&driver_id=";
    ...
    public static final String updatedocument = "http://traala.com/cabscout/driver_api.php?action=update_document&driver_id=";
    ...
    public static final String collectCashDone = "http://traala.com/cabscout/driver_api.php?action=payment_done&driver_id=";
